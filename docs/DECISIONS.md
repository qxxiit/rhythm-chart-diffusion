...
|------|----------|--------|
| 2026-05-XX | Use ActFusion-inspired discrete diffusion as main contribution | CVLab fit (Prof. M. Cho lab) + novel contribution + ActFusion is from the lab |
...
"방학 스프린트 중엔 conda base 사용, 환경 정식화(environment.yml 갱신)는 vast.ai 세팅 시점(8월 중순)에"
